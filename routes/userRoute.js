...
import { updateDetails, bookAppointment, cancelAppoinment, chatWithAI, deleteFile, fileUpload, generateToken, getAppointmentData, getFiles, getProfile, googleLogin, listAppointment, loginUser, paymentRazorpay, phoneLogin, registerUser, sendOtp, updateProfile, verifyRazorpay } from '../controllers/userController.js'
...
userRouter.post('/generate-otp', sendOtp)
userRouter.post('/phone-login', phoneLogin)
userRouter.post('/update-details', updateDetails)

userRouter.post('/update-profile', cloudinaryUpload.single('image'), authUser, updateProfile)
